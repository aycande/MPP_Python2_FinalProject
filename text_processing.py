...
ODI_projects = load_andprep_excel_data(final_data_path, 'ODI_projects_final.xlsx')
ODI_projects_cw = load_andprep_excel_data(final_data_path, 'ODI_projects_cw_final.xlsx')
UK_ICF_long = load_andprep_excel_data(final_data_path, 'UK_ICF_long_final.xlsx')
...
textfile = download_and_process_pdf(final_data_path, file_url)
...
#Word Clouds
def generate_wordcloud_from_columns(image_path, df, dfname, summary_column, year_column=None, filter_year=None):
    ...
    random_state=42,
    stopwords=stop_words              # Seed for reproducibility
)
    ...
    full_path = os.path.join(
        image_path, f'wc_{filter_year}_{dfname}.png'
    )
    plt.savefig(full_path,  dpi=300)
    plt.show()
    
generate_wordcloud_from_columns(image_path, ODI_projects, 'ODI', 'Summary', 'Year', filter_year=2015)
generate_wordcloud_from_columns(image_path, ODI_projects, 'ODI', 'Summary', 'Year', filter_year=2022)
generate_wordcloud_from_columns(image_path, ODI_projects_cw, 'ODI_cw',  'Summary ')
generate_wordcloud_from_columns(image_path, UK_ICF_long, 'UK', 'Summary', 'Year', filter_year=2015)
generate_wordcloud_from_columns(image_path, commonwealth_final, 'cw', 'Summary', image_path) 
